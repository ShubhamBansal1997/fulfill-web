...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    "DEFAULT_PAGINATION_CLASS": "fulfill.base.api.pagination.PageNumberPagination",
    "PAGE_SIZE": 30,

    # Default renderer classes for Rest framework
    "DEFAULT_RENDERER_CLASSES": [
        "fulfill.base.renderers.FulfillApiRenderer",
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": (
        ...
        "fulfill.users.auth.backends.UserTokenAuthentication",
        # Mainly used for api debug.
        "rest_framework.authentication.SessionAuthentication",
    ),
    "DEFAULT_SCHEMA_CLASS": 'rest_framework.schemas.coreapi.AutoSchema',
    "EXCEPTION_HANDLER": "fulfill.base.exceptions.exception_handler",
}
...
SITE_NAME = env("SITE_NAME", default="fulfill")
...
FRONTEND_SITE_NAME = env("FRONTEND_SITE_NAME", default="fulfill")
...
DEFAULT_FROM_EMAIL = env(
    "DEFAULT_FROM_EMAIL", default="fulfill <support@fulfill.com>"
)
EMAIL_SUBJECT_PREFIX = env("EMAIL_SUBJECT_PREFIX", default="[fulfill] ")
...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres://localhost/fulfill")
}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                "fulfill.base.context_processors.site_settings",
...
CSRF_FAILURE_VIEW = "fulfill.base.views.csrf_failure"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "fulfill": {"handlers": ["console"], "level": "INFO", "propagate": False},
